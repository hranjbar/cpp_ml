...
// Constructor
DigitsClassifier::DigitsClassifier(const std::string& modelFilepath) {
...
int DigitsClassifier::Inference(const std::string& imageFilepath) {
/**************** Create allocator ******************/
  // Allocator is used to get model information
  Ort::AllocatorWithDefaultOptions allocator;
...
void DigitsClassifier::CreateTensorFromImage(
